...
; Modified by Taran to work with Xbutton1 and F19 instead (the forward and back buttons on a 5-button mouse.)
...
#ifWinNotActive ahk_exe Adobe Premiere Pro.exe ;because I use xbutton1 and F19 for different things in Premiere. It's always full screen, so it doesn't matter. You can comment this entire line out.
